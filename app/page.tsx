export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-b from-slate-50 via-white to-slate-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 text-slate-900 dark:text-slate-50">
      <header className="sticky top-0 z-30 border-b border-slate-200 dark:border-white/5 bg-white/80 dark:bg-slate-950/80 backdrop-blur">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
          ...
          <nav className="hidden items-center gap-6 text-sm text-slate-600 dark:text-slate-200 sm:flex">
            <a
              href="#services"
          ...
          <a
            href="#contact"
            className="hidden rounded-full bg-emerald-500 px-4 py-2 text-xs font-semibold uppercase tracking-wide text-white dark:text-slate-950 shadow-lg shadow-emerald-500/30 transition hover:bg-emerald-600 dark:hover:bg-emerald-400 sm:inline-flex"
          >
            Request a quote
          </a>
        </div>
      ...
      <main className="mx-auto flex max-w-6xl flex-col gap-20 px-4 pb-16 pt-10 sm:px-6 lg:px-8 lg:gap-28 lg:pt-16">
        ...
        <section className="grid items-center gap-10 lg:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)]">
          <div className="space-y-6">
            ...
            <div className="flex flex-col gap-3 text-sm sm:flex-row sm:items-center">
              <a
                href="#contact"
                className="inline-flex items-center justify-center rounded-full bg-emerald-500 px-6 py-2.5 text-sm font-semibold text-white dark:text-slate-950 shadow-lg shadow-emerald-500/30 transition hover:bg-emerald-600 dark:hover:bg-emerald-400"
              >
                Talk to an expert
              </a>
            ...
            <dl className="mt-4 grid grid-cols-2 gap-4 text-xs text-slate-500 dark:text-slate-300 sm:text-sm md:grid-cols-3">
              <div>
              ...
              <div>
                <dt className="text-slate-500 dark:text-slate-400">Support</dt>
                <dd className="font-semibold text-slate-900 dark:text-slate-50">
          ...
          <div className="relative">
            ...
            <div className="overflow-hidden rounded-3xl border border-slate-200 dark:border-white/10 bg-white/60 dark:bg-slate-900/60 shadow-2xl shadow-black/10 dark:shadow-black/50">
              <div className="flex items-center justify-between border-b border-slate-200 dark:border-white/5 bg-white/80 dark:bg-slate-900/80 px-4 py-3">
              ...
              <div className="grid gap-4 p-4 sm:grid-cols-2">
                <div className="space-y-2 rounded-2xl border border-slate-200 dark:border-white/5 bg-white/80 dark:bg-slate-900/80 p-3">
        ...
        <section id="services" className="space-y-8">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            <div className="flex flex-col gap-3 rounded-2xl border border-slate-200 dark:border-white/10 bg-white dark:bg-slate-900/70 p-5 shadow-sm dark:shadow-none">
              <p className="text-xs font-semibold uppercase tracking-[0.18em] text-emerald-600 dark:text-emerald-300">
                CCTV Systems
              </p>
              <p className="text-sm font-semibold text-slate-900 dark:text-slate-50 sm:text-base">
        ...
        <section
          id="about"
          className="grid gap-8 border-t border-slate-200 dark:border-white/5 pt-10 lg:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)]"
        >
          <div className="space-y-4">
            ...
            <ul className="mt-4 grid gap-3 text-xs text-slate-600 dark:text-slate-200 sm:text-sm md:grid-cols-2">
          ...
          <div className="flex flex-col gap-4 rounded-3xl border border-slate-200 dark:border-white/10 bg-white dark:bg-slate-900/70 p-5 sm:p-6 shadow-sm dark:shadow-none">
            <p className="text-xs font-semibold uppercase tracking-[0.18em] text-emerald-600 dark:text-emerald-300">
              Typical use cases
            </p>
            <div className="space-y-3 text-xs text-slate-600 dark:text-slate-200 sm:text-sm">
        ...
        <section
          id="contact"
          className="space-y-8 rounded-3xl border border-emerald-500/20 dark:border-emerald-500/40 bg-linear-to-br from-emerald-50 via-white to-white dark:from-emerald-500/10 dark:via-slate-950 dark:to-slate-950 p-6 shadow-lg dark:shadow-[0_0_60px_-30px_rgba(16,185,129,0.8)] sm:p-8"
        >
          <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
            <div className="space-y-2">
              ...
              <p className="max-w-xl text-sm text-slate-600 dark:text-slate-200 sm:text-base">
          ...
          <div className="grid gap-8 lg:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)]">
            <div className="space-y-4 text-xs text-slate-600 dark:text-slate-200 sm:text-sm">
            ...
            <div className="space-y-4">
              <a
                ...
                className="flex items-center justify-center gap-3 rounded-2xl bg-emerald-500 px-5 py-3 text-sm font-semibold text-white dark:text-slate-950 shadow-lg shadow-emerald-500/40 transition hover:bg-emerald-600 dark:hover:bg-emerald-400"
              >
                <span className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-emerald-950/20 dark:bg-emerald-950/40">
      ...
      <footer className="border-t border-slate-200 dark:border-white/5 bg-slate-50 dark:bg-slate-950/90">
        <div className="mx-auto flex max-w-6xl flex-col gap-2 px-4 py-4 text-xs text-slate-500 dark:text-slate-500 sm:flex-row sm:items-center sm:justify-between sm:px-6 lg:px-8">
